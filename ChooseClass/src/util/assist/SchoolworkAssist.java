...
public class SchoolworkAssist {
    ...
    public static final String MESSAGE_ASSIST = "util.assist";
    ...
    public SchoolworkAssist(String username, String password) throws IOException, LoginException {
    ...
    private EncryptedParam encryptParams(String params) throws IOException, SecurityException, NeedLoginException {
        ...
        return new EncryptedParam(base64.encodeToString(encrypt.getBytes()), token, timestamp);
    }
...
//                .data("password", getPassword())
    ...
    public ArrayList<TableCourse> getTableCourses(Semester semester) throws IOException, NeedLoginException {
        ...
        params = base64.encodeToString(params.getBytes()).trim();
